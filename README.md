...
If you are new to DApp develoment please use this [tutorial](https://github.com/TaraTritt/dapp-starter/wiki/DApp-Development-Intro) in the wiki to get started. It contains an overview of the blockchain, Ethereum, Solidity, and DApp development. 
